...
$(document).ready(function() {
	...
	$('.compl1').on('click', function() {
		...
		$('#product-tableInfo-desc').html('Габариты рекламной конструкции без рекламоносителя (ДхВхШ)<br> \n' +
			'6000 х 2800 х 2000 мм<br> \n' +
			'Несущий каркас профильная труба <br>\n' +
			'Материал отделки: алюминиевый профиль, оцинкованный профиль, композит<br> \n' +
			'Кровля - профлист<br> \n' +
			'Стенки - монолитный поликарбонат 8мм<br> \n' +
