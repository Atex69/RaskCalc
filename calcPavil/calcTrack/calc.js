...
const STANDART_SET = [];
const BUSINESS_SET = ['map','videoMini','ik','light', 'marker', 'usb', 'adv'];
const SMART_SET = ['map', 'light', 'marker', 'usb','wifi', 'adv','tablo', 'videoCam', 'police', 'sound', 'vision'];

let currentSet = STANDART_SET;

let CHOSE_SIZE = 'small';
