...
$('#marker').change(function() {
    if(this.checked) {
        $('.content-img-marker').removeClass('img-active');


    } else {
        $('.content-img-marker').addClass('img-active');
...
$('#tablo').change(function() {
    if(this.checked) {
        $('.content-img-tablo').removeClass('img-active');


    } else {
        $('.content-img-tablo').addClass('img-active');
